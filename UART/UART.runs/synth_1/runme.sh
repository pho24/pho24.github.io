...
HD_PWD='C:/Users/phatle/UART.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_RX_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_RX_fpga.tcl
