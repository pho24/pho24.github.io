...
HD_PWD='C:/Users/phatle/UART.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_RX_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UART_RX_fpga.tcl -notrace
