set_property SRC_FILE_INFO {cfile:C:/Users/phatle/ProcessorDesign/ProcessorDesign.srcs/constrs_1/new/soc_fpga.xdc rfile:../../../ProcessorDesign.srcs/constrs_1/new/soc_fpga.xdc id:1} [current_design]
...
set_property -dict {PACKAGE_PIN W15 IOSTANDARD LVCMOS33} [get_ports {switches[4]}];  # Switch 4 select
set_property src_info {type:XDC file:1 line:17 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict {PACKAGE_PIN W18 IOSTANDARD LVCMOS33} [get_ports {LD4}];  # Sel display
set_property src_info {type:XDC file:1 line:18 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict {PACKAGE_PIN V19 IOSTANDARD LVCMOS33} [get_ports {LD3}];  # Err display
